...
/*El path de la fotografía debe ser único par cada una de estas*/
...
CREATE TABLE INVENTARIO_DPTO(
    ...
    CONSTRAINT INVETNARIO_DPTO_FK FOREIGN KEY(ID_DPTO) REFERENCES DEPARTAMENTO(ID_DPTO)
);
...
/*Creacion tabla acompañante*/
CREATE TABLE ACOMPAÑANTE(
    ID_ACOMPAÑANTE INTEGER GENERATED BY DEFAULT AS IDENTITY,
    ID_RESERVA INTEGER,
    NOMBRE_ACM VARCHAR2(60) NOT NULL,
    APELLIDOS_ACM VARCHAR2(60) NOT NULL,
    ID_DPTO INTEGER,
    ID_CLIENTE INTEGER,
    CONSTRAINT ACM_PK PRIMARY KEY(ID_ACOMPAÑANTE, ID_RESERVA),
